...
## Current - Four 4/20mA current sensors on AIN1 through AIN4

This configuration template defines the parameter settings needed to configure a BT610 IoT sensor for usage with 4 4/20mA current sensors.

Wiring points for the sensors are shown below.

![BT610 IoT Sensor 4-20mA current sensor wiring points](images/current_-_four_4-20mA_current_sensors_on_AIN1_through_AIN4.jpg)
