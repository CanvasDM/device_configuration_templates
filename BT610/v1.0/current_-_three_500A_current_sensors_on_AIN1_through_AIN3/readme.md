...
## Current - Three 500A current sensors on AIN1 through AIN3

This configuration template defines the parameter settings needed to configure a BT610 IoT sensor for usage with three 500A current sensors on AIN1 through AIN3.

Wiring points for the sensor are shown below.

![BT610 IoT Sensor 500A current sensor wiring points](images/current_-_three_500A_current_sensors_on_AIN1_through_AIN3.jpg)
...
---
**_Note:_** 500A current sensors can be connected to any AIN input, but the appropriate analog_input_type parameter must be configured accordingly.
