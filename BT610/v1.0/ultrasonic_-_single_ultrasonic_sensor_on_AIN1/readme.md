...
## Ultrasonic - single ultrasonic sensor on AIN1

This configuration template defines the parameter settings needed to configure a BT610 IoT sensor for usage with an ultrasonic sensor on input AIN1.

Wiring points for the sensor are shown below.

![BT610 IoT Sensor ultrasonic sensor wiring points](images/ultrasonic_-_single_ultrasonic_sensor_on_AIN1.jpg)
