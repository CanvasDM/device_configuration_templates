...
#
# Single thermistor configuration with thermistor on TH1 input.
################################################################################
# Set the Configuration Type, 3 represents Temperature
attr set config_type 3
# Configure Thermistors, this is a bitmask with bit 0 representing thermistor 1
attr set thermistor_config 1
